...
- Consistency across studies critical
- Statistical methods often company-specific
- Standardization reduces errors
- Opportunity for R packages to solve these problems
::::::
  -
...
:::: notes
Identifying key features to provide and solving those problems was a big part of my work but
 I will not go to deep into it but let me know if you want ot know more about it and we will se soem of those feature in demon at the end
::::
...
Scripts are often the starting point for many R users, especially in pharma where SAS scripts have been the norm. However, as analyses become more complex and need to be shared across teams or studies, the limitations of scripts become apparent. Packages provide a structured solution to all these problems - they have formal documentation systems, dependency management, built-in testing frameworks, and proper versioning.
:::::
...
- with - consistency, efficiency, compliance
and facilitate knowledge transfer between users
::::::
...
::::: notes
A big challenge for every wirting code for programmers is the design API
...
- **Code coverage**: Metric that measures the percentage of your application's code executed by your tests: [junco's coverage](https://github.com/johnsonandjohnson/junco/blob/26e7c3470e40f2e2564ba5c0aa58902ce518de06/tests/testthat/test-pruning_functions.R#L23)
...
::::: notes
- Semantic versioning - communicate breaking changes
- Git branching - isolate features, maintain stable main branch
- Code review - catch bugs early, share knowledge
- Issue tracking - prioritize work, document decisions
- Dependency management - critical for long-term maintenance
- Team workflows - establish clear contribution guidelines
:::::
...
- Internal: proprietary methods, company-specific workflows
- GitHub: faster feedback, community contributions
- CRAN: wider adoption, stricter quality standards
- Consider validation requirements for each approach
:::::::
...
::::::: notes
- Live code demonstration of package capabilities
- Key functions: split_cols_by, split_rows_by, analyze
...
- Professional-quality tables for reports
- Formatting consistent with regulatory requirements
- Exportable to various formats (RTF, PDF, HTML)
- Compare with traditional SAS output
:::::::
...
::::::: notes
- Emphasize ROI of package development
- Highlight reproducibility benefits
- Stress importance of documentation and testing
- Mention real-world impact on workflow efficiency
- Encourage audience to start small with their own packages
:::::::
...
::::::: notes
- Highlight key learning resources
- Mention R Packages book as essential reference
- Point out documentation tools (roxygen2)
- Emphasize testing frameworks (testthat)
- Note GitHub Actions for CI/CD implementation
:::::::
...
::::::: notes
- Prepare for common questions about package development
- Have examples ready for different use cases
- Be ready to discuss validation requirements
- Mention resources for further learning
- Highlight contact information for follow-up questions
:::::::
